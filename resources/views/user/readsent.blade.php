          ...
          <div class="box box-primary">
              ...
              <div class="box-footer">
                <div class='col-lg-9 col-md-9 col-xs-9 col-sm-9'>
                  @if ($mail->fromuser_id == Auth::user()->id && $mail->fromuser_status == 0)
                    <a name="linkDeleteMessage" title="delete" href="/message/sent/delete/{!!common::getEncrypt($mail->id)!!}">
                      <img src="/img/delete.png" title="delete" style="width:16px;height:16px;border:0;"> Delete
                    </a>
                  @endif
                  &nbsp;&nbsp;
                  @if ($mail->fromuser_status == 0)
                    <a href="{{ URL::previous() }}" class="small-box-footer"> <i class="fa fa-arrow-circle-left"></i> go back</a>
                  @else
                    <a href="/message/sent" class="small-box-footer"> <i class="fa fa-arrow-circle-left"></i> go back</a>
                  @endif
                </div>
                <div class='col-lg-3 col-md-3 col-xs-3 col-sm-3'>
