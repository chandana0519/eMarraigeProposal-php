          ...
          <div class="box box-primary">
              ...
              <div class="box-footer">
                <div class='col-lg-9 col-md-9 col-xs-9 col-sm-9'>
                  @if ($mail->touser_id == Auth::user()->id && $mail->touser_status == 0)
                    <a name="linkReplyMail" href="#" class="small-box-footer"> <i class="fa fa-reply-all"></i> Reply to this Mail</a>
                    &nbsp;&nbsp;
                  ...
                  @endif
                  &nbsp;&nbsp;              
                  @if ($mail->touser_status == 0)
                    <a href="{{ URL::previous() }}" class="small-box-footer"> <i class="fa fa-arrow-circle-left"></i> go back</a>
                  @else
                    <a href="/inbox" class="small-box-footer"> <i class="fa fa-arrow-circle-left"></i> go back</a>
                  @endif
                </div>
                <div class='col-lg-3 col-md-3 col-xs-3 col-sm-3'>
